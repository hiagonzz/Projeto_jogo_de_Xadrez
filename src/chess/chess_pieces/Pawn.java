         ...
         if(getColor() == Color.WHITE){
            p.setValues(position.getRow() - 1 , position.getColumn());
                ...
                if(position.getRow() == 3){
                    ...
                    if (getBoard().positionExists(left) && isThereOppentPiece(left) && getBoard().piece(left) == chessMatch.getEnPassantVulerable()) {
                        mat[left.getRow() - 1 ][left.getColumn()] = true;
                        
                    }
                       Position rigth = new Position(position.getRow(), position.getColumn() + 1);
                    if (getBoard().positionExists(rigth) && isThereOppentPiece(rigth) && getBoard().piece(rigth) == chessMatch.getEnPassantVulerable()) {
